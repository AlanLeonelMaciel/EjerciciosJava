...
que se encuentren en la frase, por algún otro carácter seleccionado por el usuario y
...
public class EggsGuia9Ej1 {
    ...
    public static void main(String[] args) {
        ...
        Cadena c1 = new Cadena("hola munda");
