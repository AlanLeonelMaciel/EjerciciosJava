 ...
 * @author alanl
 */
public class EggsRelacionesClases2 {
    ...
    public static void main(String[] args) {
        ...
        servicioJugador.CrearJugador(jugador2);
        servicioJugador.CrearJugador(jugador3);
        ...
        game.llenarJuego(jugadores, arma);
        System.out.println("");
        game.ronda();
